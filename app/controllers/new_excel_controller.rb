  ...
  def export
    ...
    Axlsx::Package.new do |p|
      p.workbook do |wb|
        ...
        gray_bg_normal_font_align_right = styles.add_style :bg_color => "C0C0C0", :sz => 16, 
        ...
        wb.add_worksheet do |sheet|
          ...
          sheet.add_row [nil, 'Sum timer pr. pers:', nil, nil, nil, nil, nil], 
            :style => [nil, gray_bg_normal_font_align_right, gray_bg_normal_font_align_right, gray_bg_normal_font_align_right, gray_bg_normal_font_align_right, gray_bg_normal_font_align_right, gray_bg_normal_font_align_right]    
