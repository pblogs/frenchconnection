...
describe Projects::TasksController, :type => :controller do
  ...
  #    task = Task.create! valid_attributes
  #    get :show, {:project_id => @project.id, :id => task.to_param},
  #      valid_session
  ...
  describe "POST create" do
    before do
      Skill.destroy_all
      @skill = Fabricate(:skill, title: 'handyman')
    end
    describe "with valid params" do
      it "creates a new Task" do
        expect {
          post :create, {:project_id => @project.id,
                         :task => valid_attributes.merge(skill_ids: [@skill.id])},
                         valid_session
  ...
  #    post :complete, {project_id: @project.id, id: task.to_param}, valid_session
