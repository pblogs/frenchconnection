  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested task_type" do
        ...
        TaskType.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => task_type.to_param, :task_type => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the task_type as @task_type" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TaskType.any_instance.stub(:save).and_return(false)
        put :update, {:id => task_type.to_param, :task_type => { "title" => "invalid value" }}, valid_session
        assigns(:task_type).should eq(task_type)
      end
